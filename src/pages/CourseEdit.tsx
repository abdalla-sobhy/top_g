...
const CourseTitleOption: options[] = [
...
export default function CourseEdit() {
  ...
  const [selectedCourseTitleOption, setselectedCourseTitleOption] =
    useState<options | null>(CourseTitleOption[0]);
            ...
            >
              ...
              >
                ...
                <Select
                  ...
                  onChange={createHandleChange(setselectedCourseTitleOption)}
                  options={CourseTitleOption}
                  isSearchable
                  styles={{
  ...
  <div className="introVideosAndOtherInputs grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
    ...
    {isAtLeastMd && <div className="flex justify-center items-center">
    ...
    <div className="col-span-1 flex flex-col gap-4">
      <label className="text-gray-600 text-sm text-right">فيديو المقدمة</label>
      <Select
                      classNamePrefix="react-select"
    ...
    <div className="col-span-1 flex flex-col gap-1.5">
      <label className={`${CourseEditCSS.label}`}>مدة الدورة (دقيقة)</label>
      <div className={CourseEditCSS.courseDurationTextBarContainer}>
        <input dir="rtl" type="number" className="courseDurationTextBarContainer" />
      </div>
    </div>

    {/* Cell 3: Audience */}
    <div className="col-span-1 flex flex-col gap-1.5">
      <label className={`${CourseEditCSS.label}`}>الجمهور المستهدف</label>
      <div className={CourseEditCSS.courseDurationTextBarContainer}>
        <input dir="rtl" type="text" className="courseDurationTextBarContainer" />
      </div>
    </div>
    ...
    <div className="col-span-1 flex flex-col gap-1.5">
      <label className={`${CourseEditCSS.label}`}>المتطلبات المسبقة</label>
      <div className={CourseEditCSS.courseDurationTextBarContainer}>
        <input dir="rtl" type="text" className="courseDurationTextBarContainer" />
      </div>
    </div>
          ...
          <div className="CourseSettings mt-12">
            <div className={CourseEditCSS.CourseDataLabel}>إعدادات الدورة</div>
            <hr />
    ...
    { (isAtLeastMd || showSidebar) && (
        <SideBar
          className={isAtLeastMd ? "" : "top-0 left-0 z-50 h-full w-4/5 bg-white"}
